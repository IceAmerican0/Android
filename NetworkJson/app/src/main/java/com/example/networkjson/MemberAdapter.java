...
public class MemberAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        tv_age.setText("Name : "+data.get(position).getAge());
        tv_hobbies.setText("Name : "+data.get(position).getHobbies());
        tv_no.setText("Name : "+data.get(position).getNo());
        tv_id.setText("Name : "+data.get(position).getId());
